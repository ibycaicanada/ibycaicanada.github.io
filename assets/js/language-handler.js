...
const translations = {
  zh: {
    ...
    intelligent_devices_content: {
      ...
      device3_description1: "安神-安定心神，促进睡眠/通络-疏通经络、化淤堵；",
      device3_description2:
        "排毒-调和气血，排毒养颜/补阳-健脾补肾，增强抵抗力；",
      device3_description3: "延年-防病治病，延年益寿；",
      device3_description4:
        "星空版石墨烯技术：穿透力强，导热性快，散热均匀，加快血液循坏；",
      device3_description5:
        "远红外线灯：让皮下深层皮肤温度上升，扩张微中管，促进血液循环，消炎镇痛；",
      device3_description6:
        "共振晶片：为细胞补充能量，矫正细胞状态，从而激活修复细胞活性；",
      device3_description7: "光子嫩肤：光子美白效果；",
      ...
      device5_description1:
        "AI 数字细胞修复仪是基于国际领先的北斗+5G+大数据技术能力，及生命信息学、量子学、细胞学、中医经络学于一体的现代化量子检测和修复设备。利用同频共振的原理， 通过微电磁波、声波来探测人身体器官组织细胞生命分子状态，与数据库正常的频率比对和分析，从而得知现在、过去以及未来 5 年的健康状况。",
      device5_description2:
        "AI 数字细胞分析仪一次性可对人体做全面筛查，包括 8 大系统，256 个脏腑，腺体、细胞、ATP、碱基对、DNA 等，能同时检测出人体 12000 多项指标，包括细胞健康状况，过敏源，微生物，寄生虫以及 96 项人体必须微量元素及矿物质。",
  ...
  en: {
    ...
    intelligent_devices_content: {
      ...
      device3_description1:
        "Calming: promotes relaxation and better sleep, activates meridian system and unblocks energy channels, dissolves clots.",
      device3_description2:
        "Detoxification: harmonizes Qi and blood, detoxifies, improves skin health and yang tonifying, strengthens the spleen and kidneys, enhances immunity.",
      device3_description3:
        "Longevity: prevents and cures diseases, and promotes longevity.",
      device3_description4:
        "Starlight graphene technology: promotes strong penetration, fast thermal conduction, and uniform heat distribution, accelerating blood circulation.",
      device3_description5:
        "Far infrared lamp: raises the temperature of the deep subcutaneous skin, expands the micro-medium vessels, promotes blood circulation, and offers anti-inflammatory and pain-relief benefits.",
      device3_description6:
        "Resonance chip: replenishes energy for cells, corrects cellular status, and activates and repairs cytoactive.",
      device3_description7:
        "Photon skin therapy: enhances skin brightness and whitening effects with photonic care.",
